...
# to make the final state match table. So just make sure the 'tnc' 'nced' and 'padus'
# variables actually mean what you think they mean before using!
# For instance if you are making multiple state match tables on the same day, you 
# can reuse code that reads in an already made tnc, nced, or padus table
...
vt <- 'nepos_vt_match_table_2026-04-16_full.csv'
tnc <- 'nepos_tnc_match_table_2026-04-16_full.csv'
nced <- 'nepos_nced_match_table_2026-04-16_full.csv'
padus <- 'nepos_padus_match_table_2026-04-16_full.csv'
